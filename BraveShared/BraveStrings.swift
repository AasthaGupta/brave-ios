...
extension Strings {
    ...
    public static let invalidSyncCodeMessage = NSLocalizedString("InvalidSyncCodeMessage", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Invalid Sync Code", comment: "Sync Alert")
